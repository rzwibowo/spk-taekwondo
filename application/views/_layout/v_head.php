	...
	<div id="main-wrapper">
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu dropdown-menu-right user-dd animated" id="user-man">
								<a class="dropdown-item disabled"
									style="font-weight: bold; background-color: #929292; color: #ffffff;">
									<i class="ti-user m-r-5 m-l-5"></i>
									{{ user.username }} [ {{ user.level }} ]
								</a>
								<a class="dropdown-item" href="<?php echo site_url() ?>/user"><i
										class="ti-panel m-r-5 m-l-5"></i> Kelola User</a>
				...
				<nav class="sidebar-nav">
					<ul id="sidebarnav" class="p-t-30">
						<li class="sidebar-item">
							<a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo site_url() ?>"
								aria-expanded="false">
						...
						<li class="sidebar-item">
							<a class="sidebar-link waves-effect waves-dark sidebar-link"
								href="<?php echo site_url() ?>/kriteria" aria-expanded="false">
						...
						<li class="sidebar-item">
							<a class="sidebar-link waves-effect waves-dark sidebar-link"
								href="<?php echo site_url() ?>/tempatlatihan" aria-expanded="false">
						...
						<li class="sidebar-item">
							<a class="sidebar-link waves-effect waves-dark sidebar-link"
								href="<?php echo site_url() ?>/analisis/kriteria" aria-expanded="false">
		...
		<div class="page-wrapper">
			...
			<div class="container-fluid" style="min-height: 100vh;">
				...
				<script
					src="<?php echo base_url() ?>assets/libs/perfect-scrollbar/dist/perfect-scrollbar.jquery.min.js">
				</script>
				<!--Wave Effects -->
