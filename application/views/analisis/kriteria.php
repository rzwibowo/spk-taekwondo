<div class="row" id="main">
      <div class="col-md-12">
            <div class="card" v-show="Steps == 1">
                <div class="card-body">
                    <h4 class="card-title text-center">Analisis Kriteria</h4>
                </div>
                <table class="table">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr v-for="colum in kriteria.colums">
                            ...
                            <th>
                                ...
                                <option v-for="nilai in Penilaian"
                                    v-bind:value="nilai.value">{{nilai.name}}</option>
                                </select>
                            </th>
                            <th>{{colum.row}}</th>
                            </template>
                ...
                <table class="table" v-if="Matrix.Matrix5">
                    <thead>
                        <tr><th>N (Kriteria)</th> <th>{{Matrix.Matrix5.N}}</th> </tr>
                        <tr><th>Hasil Akhir (X maks)</th><th>{{Matrix.Matrix5.Xmaks}}</th></tr>
                        <tr><th>IR</th><th>{{Matrix.Matrix5.IR}}</th></tr>
                        <tr><th>CI</th><th>{{Matrix.Matrix5.CI}}</th></tr>
                        <tr><th>CR</th><th>{{Matrix.Matrix5.CR}}</th></tr>
